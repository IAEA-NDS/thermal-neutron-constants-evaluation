"""Iterative Generalized Least Squares solver for Axton 1986 evaluation."""
...
# =========================================================================
# Default parameter space (38 free parameters from Axton 1986 Table 4)
# =========================================================================
...
def build_param_space(initial_params=None, fixed_params=None):
    ...
    initial_params : dict, optional
        ...
        Defaults to DEFAULT_INITIAL_PARAMS.
    fixed_params : dict, optional
        Maps (quantity, nuclide) -> fixed value.
        Defaults to DEFAULT_FIXED_PARAMS.
